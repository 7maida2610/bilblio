...
final class Version20251116230548 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($isPostgres) {
            ...
            $this->addSql('CREATE TABLE IF NOT EXISTS "user" (id SERIAL NOT NULL, email VARCHAR(180) NOT NULL, username VARCHAR(255) NOT NULL, roles JSON NOT NULL, password VARCHAR(255) NOT NULL, last_login TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL, is_active BOOLEAN NOT NULL, PRIMARY KEY(id))');
