...
final class Version20251117072736 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($isPostgres) {
            // PostgreSQL syntax
            $this->addSql('ALTER TABLE auteur ADD created_by_id INT DEFAULT NULL');
            $this->addSql('ALTER TABLE auteur ADD updated_by_id INT DEFAULT NULL');
            $this->addSql('ALTER TABLE auteur ADD created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
            $this->addSql('ALTER TABLE auteur ADD updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
            $this->addSql('ALTER TABLE categorie ADD created_by_id INT DEFAULT NULL');
            $this->addSql('ALTER TABLE categorie ADD updated_by_id INT DEFAULT NULL');
            ...
            $this->addSql('ALTER TABLE editeur ADD created_by_id INT DEFAULT NULL');
            $this->addSql('ALTER TABLE editeur ADD updated_by_id INT DEFAULT NULL');
            $this->addSql('ALTER TABLE editeur ADD created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
            $this->addSql('ALTER TABLE editeur ADD updated_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
            $this->addSql('ALTER TABLE livre ADD created_by_id INT DEFAULT NULL');
            $this->addSql('ALTER TABLE livre ADD updated_by_id INT DEFAULT NULL');
            $this->addSql('ALTER TABLE livre ADD created_at TIMESTAMP(0) WITHOUT TIME ZONE DEFAULT NULL');
