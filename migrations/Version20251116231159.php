...
final class Version20251116231159 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if ($isPostgres) {
            ...
            // Only add constraint if it doesn't exist (use exception handling)
            $this->addSql('DO $$ BEGIN ALTER TABLE activity_log ADD CONSTRAINT FK_FD06F647A76ED395 FOREIGN KEY (user_id) REFERENCES "user" (id); EXCEPTION WHEN duplicate_object THEN NULL; END $$;');
        } else {
            // MySQL syntax
